...
//  mongoose.connect("mongodb+srv://swetha:swetha@cluster0.aemiq.mongodb.net/priya?retryWrites=true&w=majority&appName=Cluster0").then(()=>console.log("db connect")).catch((err)=>console.log(err))
...
//         rejectedThisMonth: {
//           $sum: {
//             $cond: [{ $eq: ["$completedTheCourse", "No"] }, 1, 0],
//           },
//         },
//         joinedThisMonth: {
//           $sum: {
...
// Get students for a specific month and year
app.get("/students/:admissionMonth/:admissionYear", (req, res) => {
  const { admissionMonth, admissionYear } = req.params;
